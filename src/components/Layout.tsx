...
export const menuItems = [
  { name: "모든 글", path: "/blog/", exact: false, icon: "newspaper" },
  { name: "post", path: "/post/", exact: false, icon: "newspaper" },
  { name: "TIL", path: "/til/", exact: false, icon: "newspaper" },
  { name: "tip", path: "/tip/", exact: false, icon: "newspaper" },
];
